    ...
    <section id="contact" className="py-20 relative">
      ...
      <div className="container mx-auto px-4">
        <motion.h2 
          ...
          className="text-4xl md:text-5xl font-display font-black mb-16 text-center text-white tracking-tighter"
        >
          ...
          >
            <div className="relative group">
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white font-mono focus:outline-none focus:border-cyan-400 transition-colors placeholder-gray-600"
              />
            ...
            <div className="relative group">
              <textarea 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white font-mono focus:outline-none focus:border-cyan-400 transition-colors placeholder-gray-600 resize-none"
              ></textarea>
            </div>

            <button className="w-full py-4 bg-gradient-to-r from-cyan-400 to-purple-600 text-black font-bold font-mono uppercase tracking-widest rounded-lg hover:shadow-[0_0_20px_rgba(0,243,255,0.4)] transition-all">
              Send Message
            </button>
          </motion.form>
        </div>
